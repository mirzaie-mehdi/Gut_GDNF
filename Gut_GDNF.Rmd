...
#human_exClu <- readRDS('data/rds/HumanAB_150exClu.rds')
#mice_exClu <- readRDS('data/rds/MiceAB_150exClu.rds')
```
...
write.table(out.s, "data/clastering/HumanA_40clustered.txt", quote=F, sep="\t")
################################
# summary table for the cluster results
################################
out.s <- read.delim('data/clastering/HumanA_40clustered.txt')
dat   <- as.matrix(out.s)
##########
...
write.table(out.c, "data/clastering/HumanA_40cluID.txt", quote=F, sep="\t")
write.table(out.n, "data/clastering/HumanA_40cluNum.txt", quote=F, sep="\t")
################################
rm(list=setdiff(ls(), sel_var))
```
...
```{r}
out.s <- read.delim('data/clastering/HumanAB_150clustered.txt')
...
saveRDS(exClu,'data/rds/HumanA_40exClu.rds')
#######################
rm(list=setdiff(ls(), sel_var))
